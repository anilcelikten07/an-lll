<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="~/Secret/biletal.aspx.cs" Inherits="biletall" Title="Bilet Alma" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content1" runat="Server">
    <table align="center">
        <tr>       
            <td>
               <strong> <asp:Label ID="lblheat" runat="server" Text="Bilet Al" Font-Size= "X-Large"  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="63%" align="left" height="27">
                                                            <asp:DropDownList CssClass="form" ID="Source" runat="server">
                                                                ...
                                                                <asp:ListItem Text="Antalya" Value=""></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="rfvph" ControlToValidate="txtphone" ErrorMessage="Geçersiz Numara"
                                                                        runat="server" />
                                                                    <asp:RangeValidator ID="rangephnumber" Text="Geçersiz Numara" Type="Double" MaximumValue="10000000000"
                                                                        MinimumValue="1" ControlToValidate="txtphone" runat="server" />
                                                                </td>
                                                                <tr>
                                                                    <td align="left" height="25">
                                                                        Aldğınız Toplam Koltuk Sayısı
                                                                    </td>
                                                                    <td align="left">
                                                                        :
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td align="left" height="25">
                                                                        Koltuk Başına Ödeyeceğiniz Ücret
                                                                    </td>
