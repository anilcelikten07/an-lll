...
public partial class YeniKayit : System.Web.UI.Page
{
    ...
    protected void CreateUserWizard1_CreatingUser(object sender, LoginCancelEventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            string qry = "select count(*) from kullanicibilgi where [kullaniciadi]='" + CreateUserWizard1.UserName.Trim() + "'";
            ...
            qry = "insert into kullanicibilgi ([kullaniciadi],[sifre],Gsoru,Gcevap,EMail) values ('{0}','{1}','{2}','{3}','{4}')";
            ...
            try
            {
                ...
                Response.Redirect("digerbilgiler.aspx?name="+CreateUserWizard1.UserName.ToString()+"");   
            }
            catch (Exception)
            {
